...
CONFIG = SettingsFile(
    ...
    need_restore=True,
    default={
        "activation_code": "",  # Не используется (активация отключена)
        "playerok": {
            "api": {
                "token": "",
                "cookies": "",
...
DATA_REPLACEMENTS = SettingsFile(
    name="data_replacements",
    path=paths.DATA_REPLACEMENTS_FILE,
    need_restore=False,
    default=[]
)
