    ...
    try:
        ...
        if value == "-":
            ...
            await throw_float_message(
                state=state,
                message=message,
                text=templ.settings_watermark_float_text("✅ <b>Водяной знак</b> отключён."),
        ...
        # Орёл всегда впереди водяного знака
        ...
        await throw_float_message(
            state=state,
            message=message,
            text=templ.settings_watermark_float_text(f"✅ <b>Водяной знак</b> установлен:\n{value}"),
            reply_markup=templ.back_kb(calls.SettingsNavigation(to="watermark").pack())
        )
    except Exception as e:
        await throw_float_message(
