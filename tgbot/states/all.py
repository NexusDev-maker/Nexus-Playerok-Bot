...
class SystemStates(StatesGroup):
    ...
    waiting_for_playerok_auth_cookies = State()
    waiting_for_playerok_auth_choose_user_agent = State()
    waiting_for_playerok_auth_user_agent = State()
    waiting_for_playerok_auth_proxy = State()
...
class RaiseItemsStates(StatesGroup):
    ...
    waiting_for_raise_after_position = State()
...
class DataReplacementStates(StatesGroup):
    waiting_for_new_keyphrases = State()
