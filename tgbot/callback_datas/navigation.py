...
class FinanceNavigation(CallbackData, prefix="finpag"):
    to: str  # main, transactions, cards, withdraw


class ReviewsNavigation(CallbackData, prefix="revpag"):
    to: str  # main


class DataReplacementsNavigation(CallbackData, prefix="drnav"):
    to: str  # main
